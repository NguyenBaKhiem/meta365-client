...
const RegularAction = () => {
  ...
  const handleSell = async () => {
    ...
    if (land.onSale) return showNotificationError("Land is on sale");
    if (!startingValue || !endingValue || !duration || !date)
      return showNotificationError("Please fill all fields");
